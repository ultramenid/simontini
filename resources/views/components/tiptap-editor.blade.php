...
<div>
    ...
    <div data-tiptap-wrapper data-tiptap-picker-id="{{ $wireModel }}" data-tiptap-reference-page-url="{{ route('cms.reference', ['picker' => 1, 'editor' => $wireModel]) }}">
        <div wire:ignore>
            ...
            <div class="border-b border-gray-300 bg-[#f7f8fa]">
                <div class="tiptap-ribbon">
                    <div class="tiptap-ribbon-group">
                        <div class="tiptap-ribbon-controls">
                            <button type="button" title="Undo" data-tiptap-command="undo" class="tiptap-toolbar-button text-lg">↶</button>
                            <button type="button" title="Redo" data-tiptap-command="redo" class="tiptap-toolbar-button text-lg">↷</button>
                        </div>
                        <span class="tiptap-ribbon-label">Riwayat</span>
                    </div>

                    <div class="tiptap-ribbon-group tiptap-ribbon-group--font">
                        <div class="tiptap-ribbon-controls flex-wrap">
                            ...
                            <select data-tiptap-select="lineHeight" title="Jarak antarbaris" class="tiptap-toolbar-select">
                                <option value="">Jarak baris</option>
                            ...
                            <label title="Warna teks" class="tiptap-toolbar-button cursor-pointer gap-1">
                                <span class="font-bold underline decoration-2 decoration-[#376A64]">A</span>
                                <input type="color" value="#1f2937" data-tiptap-color="color" class="h-4 w-4 cursor-pointer border-0 bg-transparent p-0">
                            </label>
                            <label title="Warna highlight" class="tiptap-toolbar-button cursor-pointer gap-1">
                                <span class="bg-yellow-200 px-1 font-bold">A</span>
                                <input type="color" value="#fef08a" data-tiptap-color="backgroundColor" class="h-4 w-4 cursor-pointer border-0 bg-transparent p-0">
                            </label>
                        </div>
                        <span class="tiptap-ribbon-label">Font</span>
                    </div>
                    ...
                    <div class="tiptap-ribbon-group">
                        ...
                        <span class="tiptap-ribbon-label">Paragraf</span>
                    </div>
                    ...
                    <div class="tiptap-ribbon-group">
                        <div class="tiptap-ribbon-controls flex-wrap">
                            ...
                            <button type="button" title="Pilih gambar dari Reference" data-tiptap-image-picker class="tiptap-toolbar-button gap-1">
                                <svg class="h-4 w-4" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" aria-hidden="true"><rect x="3" y="3" width="18" height="18" rx="2"/><circle cx="8.5" cy="8.5" r="1.5"/><path stroke-linecap="round" stroke-linejoin="round" d="m21 15-5-5L5 21"/></svg>
                                Image
                            </button>
                            <button type="button" title="Tambah tabel 3×3" data-tiptap-command="insertTable" class="tiptap-toolbar-button">Tabel</button>
                        ...
                        <span class="tiptap-ribbon-label">Sisipkan</span>
                    </div>
                    ...
                    <div class="tiptap-ribbon-group">
                        <div class="tiptap-ribbon-controls">
                            ...
                            <button type="button" title="Code block dengan syntax color" data-tiptap-command="codeBlock" data-tiptap-active="codeBlock" class="tiptap-toolbar-button font-mono">Block</button>
                            <button type="button" title="Source code" aria-label="Source code" data-tiptap-source-toggle class="tiptap-toolbar-button border border-gray-300 bg-white">
                                <svg class="h-5 w-5" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.25" aria-hidden="true"><path stroke-linecap="round" stroke-linejoin="round" d="m8 5-7 7 7 7M16 5l7 7-7 7"/></svg>
                            </button>
                        </div>
                        <span class="tiptap-ribbon-label">Kode</span>
                    </div>
                </div>

                <div data-tiptap-table-tools class="hidden border-t border-emerald-200 bg-emerald-50 px-3 py-2">
                    <div class="flex flex-wrap items-center gap-1.5">
                        <span class="mr-1 text-[10px] font-bold uppercase tracking-wider text-emerald-700">Format tabel</span>
                ...
                <div data-tiptap-selected-image-tools class="hidden flex-wrap items-center gap-2 border-t border-blue-200 bg-blue-50 px-3 py-2">
                    <span class="mr-1 text-[10px] font-bold uppercase tracking-wider text-blue-700">Format gambar</span>
