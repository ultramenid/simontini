<div class=" mb-2 " x-data={download:false}>
    <div class="flex gap-2">
        ...
        <div class="flex flex-col ">
            ...
            {{-- <a target="_blank" href="https://aws.simontini.id/geoserver/wfs?service=WFS&version=1.0.0&request=GetFeature&typeName={{$layerName}}&outputFormat=SHAPE-ZIP" x-show="download" class="text-xs flex items-center cursor-pointer text-atas">
