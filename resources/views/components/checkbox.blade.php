@props(['idAttr' => null, 'layerName' => null])
<div class=" mb-2 " x-data={download:false}>
    <div class="flex gap-2">
        <label for="{{$idAttr}}" class="flex  cursor-pointer select-none text-dark dark:text-white" >
            <div class="relative" >
                <input type="checkbox" id="{{$idAttr}}" class="peer sr-only checkelement" @click="download=!download" />
