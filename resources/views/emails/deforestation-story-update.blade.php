...
<body style="margin:0;background:#f3f6f5;font-family:Arial,sans-serif;color:#1a1a1a">
    <div style="max-width:640px;margin:0 auto;padding:32px 16px">
        <div style="background:#fff;border:1px solid #d9e1df;padding:32px">
            ...
            <a href="{{ $storyUrl }}" style="display:inline-block;background:#376A64;color:#fff;padding:13px 20px;text-decoration:none;font-size:12px;font-weight:700;text-transform:uppercase">{{ $locale === 'en' ? 'View story update' : 'Lihat pembaruan story' }}</a>
        </div>
    </div>
</body>
</html>
