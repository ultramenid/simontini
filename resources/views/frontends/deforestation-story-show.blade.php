...
@section('content')
    ...
    <div id="site-loader" class="site-loader--story" role="status" aria-live="polite" aria-label="{{ $locale === 'en' ? 'Loading' : 'Memuat' }} {{ $story->localized_title }}">
        <div class="loader-mark">
            <img src="{{ asset('assets/logo-simontinus-loader.webp') }}" alt="" width="225" height="48">
            <div class="loader-sub">{{ $story->localized_title }}</div>
    ...
    >
        <article>
            <header class="mx-auto max-w-[720px] px-5 pt-10 text-center sm:px-8 sm:pt-14">
                <h1 class="mx-auto {{ $dateVisible ? 'mb-4' : 'mb-[42px]' }} max-w-[720px] text-center text-[40px] font-bold leading-[1.28] text-black">{{ $story->localized_title }}</h1>
            ...
            @if ($story->localized_image)
                <figure class="mx-auto max-w-[1200px] px-5 pt-8 sm:px-8 sm:pt-10 lg:px-12">
                    ...
                    @if (filled($story->localized_image_description))
                        <figcaption class="hero-image-caption pt-1 text-left text-[12px] font-normal leading-[1.6] text-gray-800">
            ...
            <div class="mx-auto max-w-[720px] px-5 pt-10 sm:px-8 sm:pt-14">
                <div class="article-copy public-story-content text-[15px] leading-[1.85] text-gray-800 sm:text-[17px]">
                    {!! \App\Support\StoryChartTables::append($story->localized_content) !!}
                </div>
