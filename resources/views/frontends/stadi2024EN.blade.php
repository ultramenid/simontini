...
<div class="swiper-wrapper">
    ...
    <div class="swiper-slide px-4 py-12 flex flex-col  bg-gray-100 relative">
        <a href="https://simontini.id/assets/stadi2024/1-biomassa-mhl.jpg" class="glightbox21 mt-4 gbox" data-gallery="gallery1"  data-glightbox=" description: Deforestasi untuk pembangunan kebun kayu energi dalam konsesi PT Malinau Hijau Lestari di Kalimantan Utara. Deforestasi ini berpotensi legal karena kawasan tersebut telah dilepaskan Kementerian Lingkungan Hidup dan Kehutanan dari kawasan hutan sehingga menjadi Area Penggunaan Lain (APL). Foto: Mei 2024 @Auriga Nusantara">
...
<div x-data="{swiper: null}" x-init="swiper = new Swiper($refs.container, {
    ...
    <div class="swiper-container relative" x-ref="container">
        ...
        <div class="swiper-wrapper">
            ...
            <!-- Slides -->
            <div class="swiper-slide px-4 py-12 flex flex-col  bg-gray-100 relative">
                <a href="https://simontini.id/assets/stadi2024/3-lahan-cakrawala.jpg" class="glightbox8 mt-4 gbox" data-glightbox="description: Deforestasi demi pembangunan kebun kayu dalam konsesi PT Lahan Cakrawala di Kalimantan Barat. Foto: Desember 2024, @Auriga Nusantara.">
            ...
            <!-- Slides -->
            <div class="swiper-slide px-4 py-12 flex flex-col  bg-gray-100 relative">
                <a href="https://simontini.id/assets/stadi2024/3-jaya-bumi-paser.jpg" class="glightbox8 mt-4 gbox" data-glightbox="description: Pembabatan hutan alam demi pembangunan kebun kayu energi di dalam konsesi PT Jaya Bumi Paser di Kalimantan Timur. Foto: Mei 2024, @Auriga Nusantara">
            ...
            <!-- Slides -->
            <div class="swiper-slide px-4 py-12 flex flex-col  bg-gray-100 relative">
                <a href="https://simontini.id/assets/stadi2024/3-babugus.jpg" class="glightbox8 mt-4 gbox" data-glightbox="description: Pembangunan jaringan jalan persiapan pembabatan hutan alam demi pengembangan kebun kayu energi/biomassa dalam konsesi PT Babugus Wahana Lestari di Kalimantan Tengah. Foto: Agustus 2024 @Auriga Nusantara/Earthsight">
...
<div class="swiper-wrapper">
    ...
    <!-- Slides -->
    <div class="swiper-slide px-4 py-12 flex flex-col  bg-gray-100 relative">
        <a href="https://simontini.id/assets/stadi2024/4-anugerah-langkat-makmur.jpg" class="glightbox9 mt-4 gbox" data-glightbox="description: Deforestasi untuk pembangunan kebun sawit di konsesi PT Anugerah Langkat Makmur di Kabupaten Mandailing Natal, Sumatera Utara. Foto: Februari 2024, @Auriga Nusantara/Konsorsium Pembaruan Agraria">
    ...
    <!-- Slides -->
    <div class="swiper-slide px-4 py-12 flex flex-col  bg-gray-100 relative">
        <a href="https://simontini.id/assets/stadi2024/4-DRT.jpg" class="glightbox9 mt-4 gbox" data-glightbox=" description: Lokasi ini berada dalam konsesi logging PT Diamond Raya Timber di Riau. Namun, kesaksian masyarakat setempat maupun dokumentasi kunjungan lapangan menunjukkan bahwa deforestasi ini untuk pembangunan kebun sawit. Pembangunan kebun sawit di dalam konsesi logging juga ditemukan dalam konsesi PT Anugerah Pratama Inspirasi di Bengkulu yang dikunjungi pada Februari 2024. Foto: Desember 2024, @Auriga Nusantara">
    ...
    <!-- Slides -->
    <div class="swiper-slide px-4 py-12 flex flex-col  bg-gray-100 relative">
        <a href="https://simontini.id/assets/stadi2024/4-bssu.jpg" class="glightbox9 mt-4 gbox" data-glightbox="description: Deforestasi untuk pembangunan kebun sawit dalam konsesi PT Bina Sawit Sarana Utama di Kalimantan Tengah. Foto: November 2024, @Auriga Nusantara/Earthsight">
...
<div class="swiper-wrapper">
    <!-- Slides -->
    <div class="swiper-slide px-4 py-12 flex flex-col  bg-gray-100 relative">
        <a href="https://simontini.id/assets/stadi2024/6-gag-nikel.jpg" class="glightbox11 mt-4 gbox" data-glightbox=" description:  Deforestasi oleh tambang nikel PT Gag Nikel di pulau kecil Gag di Raja Ampat, Papua Barat Daya. Foto: Desember 2024, @Auriga Nusantara">
    ...
    <!-- Slides -->
    <div class="swiper-slide px-4 py-12 flex flex-col  bg-gray-100 relative">
        <a href="https://simontini.id/assets/stadi2024/6-pt-ksm.jpg" class="glightbox11 mt-4 gbox" data-glightbox="description: Deforestasi oleh penambangan nikel PT Kawei Sejahtera Mining di pulau kecil Kawei di Raja Ampat. Foto: Desember 2024, @Auriga Nusantara">
    ...
    <!-- Slides -->
    <div class="swiper-slide px-4 py-12 flex flex-col  bg-gray-100 relative">
        <a href="https://simontini.id/assets/stadi2024/6-pt-ksp.jpg" class="glightbox11 mt-4 gbox" data-glightbox=" description: Deforestasi oleh penambangan nikel PT Anugerah Surya Pratama di pulau kecil Manuram, Raja Ampat. Foto: Desember 2024, @Auriga Nusantara">
    ...
    <!-- Slides -->
    <div class="swiper-slide px-4 py-12 flex flex-col  bg-gray-100 relative">
        <a href="https://simontini.id/assets/stadi2024/6-batang-pele.jpg" class="glightbox11 mt-4 gbox" data-glightbox="description: Di pulau kecil Batang Pele di Raja Ampat ini telah diterbitkan izin tambang nikel PT Mulya Raymond Perkasa. Foto: Desember 2024, @Auriga Nusantara">
    ...
    <!-- Slides -->
    <div class="swiper-slide px-4 py-12 flex flex-col  bg-gray-100 relative">
        <a href="https://simontini.id/assets/stadi2024/6-imm-sarmi.jpeg" class="glightbox11 mt-4 gbox" data-glightbox="description: Danau dan hutan alam ini terancam hilang karena di lahan ini telah diterbitkan izin tambang nikel PT Iriana Mutiara Mining. Foto: Desember 2024, @Auriga Nusantara">
...
<div class="swiper-wrapper">
    <!-- Slides -->
    <div class="swiper-slide px-4 py-12 flex flex-col  bg-gray-100 relative">
        <a href="https://simontini.id/assets/stadi2024/5-bintang-delapan.jpg" class="glightbox12 mt-4 gbox" data-glightbox=" description: Deforestasi dalam konsesi tambang nikel PT Bintang Delapan Mineral di Sulawesi Tengah. Foto: Desember 2024, @Auriga Nusantara">
            <img src="https://simontini.id/assets/stadi2024/5-bintang-delapan.jpg" alt="Simontini - stadi 2024" class="h-[50vh] w-full object-cover object-top rounded-lg hover:brightness-50 transition duration-300 ease-in-out" />
        </a>
        <p class=" text-black font-light sm:text-sm text-xs mt-2 text-left  leading-relaxed">
            Deforestasi dalam konsesi tambang nikel PT Bintang Delapan Mineral di Sulawesi Tengah. Foto: Desember 2024, @Auriga Nusantara</p>
    ...
    <!-- Slides -->
    <div class="swiper-slide px-4 py-12 flex flex-col  bg-gray-100 relative">
        <a href="https://simontini.id/assets/stadi2024/5-hengjaya.jpg" class="glightbox12 mt-4 gbox" data-glightbox="description: Deforestasi di dalam konsesi tambang nikel PT Hengjaya Mineralindo di Morowali, Sulawesi Tengah. Foto: Desember 2024, @Auriga Nusantara">
            <img src="https://simontini.id/assets/stadi2024/5-hengjaya.jpg" alt="Simontini - stadi 2024" class="h-[50vh] w-full object-cover object-top rounded-lg hover:brightness-50 transition duration-300 ease-in-out" />
        </a>
        <p class=" text-black font-light sm:text-sm text-xs mt-2 text-left  leading-relaxed">
            Deforestasi di dalam konsesi tambang nikel PT Hengjaya Mineralindo di Morowali, Sulawesi Tengah. Foto: Desember 2024, @Auriga Nusantara
