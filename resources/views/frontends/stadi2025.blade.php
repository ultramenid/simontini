...
<section class="page-section px-[5vw]">
    ...
    <p class="lead">
        Pada November 2021 dalam ajang KTT Iklim ke-26 Glasgow, Skotlandia, pemimpin 144 negara, termasuk Indonesia, menandatangani
        <a href="https://webarchive.nationalarchives.gov.uk/ukgwa/20230418175226/https:/ukcop26.org/glasgow-leaders-declaration-on-forests-and-land-use/" target="_blank" rel="noopener noreferrer" style="color: #bc4a3c;">Glasgow Leaders</a>.
        Declaration on Forest and Land Use atau Glasgow Declaration. Deklarasi ini merupakan kesepakatan untuk bekerja secara kolektif menghentikan dan membalik hilangnya hutan dan degradasi lahan.
    </p>
    <p class="body-text">
    Di Indonesia, upaya untuk menghentikan deforestasi atau hilangnya hutan alam tidak bermula dari deklarasi tersebut. Satu dekade sebelumnya, Presiden Susilo Bambang Yudhoyono menandatangani Instruksi Presiden No. 10 tahun 2011, biasa disebut
    <a href="https://peraturan.bpk.go.id/Download/68485/Inpres_no_10_2011.pdf" target="_blank" rel="noopener noreferrer" style="color: #bc4a3c;">Inpres Moratorium</a>,
    yang melarang penerbitan izin konversi di hutan alam primer dan lahan gambut dilindungi. Presiden Joko Widodo yang meneruskan kebijakan tersebut juga menerbitkan Instruksi Presiden No. 8 tahun 2018, atau Inpres
    <a href="https://peraturan.bpk.go.id/Download/261461/Inpres%20Nomor%208%20Tahun%202018.PDF" target="_blank" rel="noopener noreferrer" style="color: #bc4a3c;">Moratorium Sawit</a>,
    yang diharapkan dapat mengoptimalkan kebun-kebun sawit eksisting dan menghentikan laju deforestasi oleh ekspansi sawit.
    </p>
    <p class="body-text">
    Indonesia pun meratifikasi Kesepakatan Paris (Paris Agreement), yang dimaksudkan untuk menahan kenaikan suhu global di bawah 2°C, sembari berupaya membatasi kenaikannya maksimum 1,5°C dari era pra-industri. Dalam kerangka ini, Pemerintah Indonesia menerbitkan
    <a href="https://peraturan.bpk.go.id/Download/180699/Perpres%20Nomor%2098%20Tahun%202021.pdf" target="_blank" rel="noopener noreferrer" style="color: #bc4a3c;">Peraturan Presiden No. 98 tahun 2021</a>
    tentang Penyelenggaraan Nilai Ekonomi Karbon dan menerjemahkannya lebih rinci melalui Keputusan Menteri LHK No. 168 tahun 2022 tentang Indonesia’s
    <a href="https://eos.co.id/main/wp-content/uploads/2022/03/1647210373656.pdf" target="_blank" rel="noopener noreferrer" style="color: #bc4a3c;">FOLU Net Sink 2030</a>
    untuk Pengendalian Perubahan Iklim.
    </p>
    <p class="body-text">
    Berbagai kebijakan tersebut membuat deforestasi di Indonesia menurun dalam lima tahun berturut-turut sejak 2017. Namun, sejak 2022 deforestasi Indonesia kembali meningkat, sebagaimana terlihat dalam grafik berikut. Bahkan, deforestasi di Indonesia melonjak pada 2025.
    </p>
...
<section class="page-section px-[5vw]  section-after-chart">
    ...
    <p class="body-text">
    <strong>Tahapan dan pemrosesan data.</strong> Peta deforestasi 2025 diperoleh dengan pemodelan deep learning pada citra satelit Sentinel. Tahapannya sebagai berikut.
    </p>
    ...
    <div class="method-steps">
        ...
        <div class="body-text">
            <p>
            <em>Pertama, </em>
            pemodelan deforestasi. Pengetahuan yang terkumpul selama ini, seperti dari pemantauan lapangan dan data-data deforestasi
            <a href="https://simontini.id/presentation/Deforestasi_Indonesia-2023-paparan.pdf" target="_blank" rel="noopener noreferrer" style="color: #bc4a3c;">2023</a>

            dan
            <a href="https://simontini.id/id/status-deforestasi-indonesia-2024" target="_blank" rel="noopener noreferrer" style="color: #bc4a3c;">2024</a>,
            dimodelkan dengan
            <em>deep learning</em>
        ...
        <div class="body-text">
            ...
            <p>
            <em>Kedua</em>, penentuan area cakupan (<em>scoping area</em>). Isyarat deforestasi (<em>deforestation alert</em>, atau biasa disebut GLAD alert) bulanan yang diproduksi Universitas Maryland dikumpulkan. Demi efektivitas, yang dikumpul hanya isyarat dengan tingkat kepercayaan tinggi (<em>high confidence</em>). Isyarat-isyarat ini kemudian “diikat” atau diagregasi pada satu kotak (<em>bounding box</em>) bersisi 10.240 meter. Bounding boxes inilah yang menjadi area cakupan.
        ...
        <div class="body-text">
            ...
            <p>
            <em>Ketiga</em>, model deforestasi yang telah dibangun kemudian dijalankan pada citra satelit Sentinel 2 resolusi 10 meter di area-area cakupan.
            </p>
        </div>
        </div>
        <div class="method-step">
...
<section class="page-section px-[5vw] py-8">
  ...
  <p class="body-text">
    Dengan metode tersebut, <strong> di Indonesia pada 2025 mencapai 433.751 hektare</strong>. Deforestasi ini meningkat sebesar 66% dari tahun sebelumnya seluas
    <a href="https://simontini.id/id/status-deforestasi-indonesia-2024" target="_blank" rel="noopener noreferrer" style="color: #bc4a3c;">261.575 hektare</a>.
    Deforestasi terluas kembali terjadi di Kalimantan, disusul Sumatera. Tanah Papua, yang pada 2024 berada di peringkat keempat, pada tahun 2025 menempati peringkat ketiga menggantikan Sulawesi.
  </p>
  <p class="body-text">
