                            ...
                            <div id="chart-body" class="relative flex" style="height:420px;">
                                ...
                                <div id="bars-wrap" class="relative flex-1 flex flex-col">
                                    ...
                                    <div id="bars-svg-wrap"
                                        class="absolute inset-x-0 top-0 bottom-[60px] grid items-end gap-[2px] px-0.5">
                                    </div>
                                    <div id="x-axis"
                                        class="relative grid gap-[2px] px-[2px] mt-2 h-[60px] items-start overflow-hidden"
        ...
        <section class="page-section px-[5vw] py-10">
            ...
            <div>
                ...
                <p class="body-text">
                    ...
                    Indonesia
                    <a href="https://simontini.id/id/status-deforestasi-indonesia-2024" target="_blank"
                        rel="noopener noreferrer" style="color: #bc4a3c;">sejak 2013</a>,
            ...
            <div class="method-steps">
                <div class="border-b pt-0 pb-12">
                    <div class="method-step">
                        <div class="ms-num">1.</div>
                        <div>
                            <h4 class="chapter-title">Penerbitan regulasi yang memastikan perlindungan seluruh hutan alam
                                tersisa di
                                Indonesia.</h4><br>
                            <p class="body-text">
                                ...
                                bawahnya, yakni
                                peraturan pemerintah, pun tak jarang memerlukan waktu lama untuk pembuatannya, terutama oleh
                                kerumitan
                                dan
                                ...
                                menjawab
                                persoalan,
                                sebagai rem darurat. Maka, saatnya Presiden Prabowo menerbitkan peraturan presiden mengenai
                                perlindungan
                ...
                <div class="method-steps border-b">
                    <div class="border-b pt-0 pb-12">
                        <div class="method-step ">
                            <div class="ms-num">2.</div>
                            <div class="-mb-12">
                                <h4 class="chapter-title">Pengadaan dan pemberlakuan instrumen pengendalian revisi tata
                                    ruang.</h4><br>
                                <p class="body-text ">
                                    pertengahan 2023 publik dikejutkan dengan usulan revisi tata ruang Provinsi Kalimantan
                                    Timur yang
                                    ditengarai akan melepaskan 612.355 hektare kawasan hutan (menjadi area penggunaan lain),
                                    menurunkan
                                    fungsi
                                    kawasan hutan (sehingga memungkinkan ditambang) seluas 101.788 hektare. Padahal,
                                    setidaknya 389.596
                                    hektare
                                    <a href="https://www.youtube.com/watch?v=Mx4638DmEjI" target="_blank"
                                        rel="noopener noreferrer" style="color: #bc4a3c;">(55%) area ini bertutupan hutan
                                        alam</a>.
                                    Sementara, beberapa bulan sebelumnya Pemerintah Provinsi Kalimantan Utara mengusulkan
                                    revisi tata
                                    ruang
                                    yang akan mengalihkan fungsi kawasan hutan seluas
                                    <a href="https://korankaltara.com/762-ribu-hektare-hutan-diusulkan-beralih-fungsi"
                                        target="_blank" rel="noopener noreferrer" style="color: #bc4a3c;">762.000
                                        hektare</a>.
                ...
                <div class="method-step border-b">
                    ...
                    <div class="">
                        ...
                        <p class="body-text">
                            ...
                            Undang-Undang
                            Konservasi 32/2024 telah membuka ruang untuk ini, yakni sebagai area preservasi. Namun,
                            kekosongan
                            peraturan pelaksananya mengakibatkan belum adanya perwujudan area preservasi hingga saat ini.
                            Oleh karena
                            ...
                            manfaat
                            ekonominya, oleh dan untuk pemerintah daerah atau komunitas lokal dengan kordinasi atau
                            supervisi oleh
                ...
                <div class="border-b py-12">
                    <div class="method-step">
                        <div class="ms-num">4.</div>
                        <div class="">
                            <h4 class="chapter-title">Redistribusi kelembagaan dan aparatur pengelola hutan sehingga
                                seluruh tutupan
                                hutan alam memiliki aparatur penjaga.</h4><br>
                            <p class="body-text">
                                Presiden Prabowo disebut telah memerintahkan penggandaan jumlah polisi hutan. Satu langkah
                                yang
                                semestinya
                                patut diapresiasi. Akan tetapi, sebagaimana pernah
                                <a href="https://www.youtube.com/watch?v=fXpCyo4TrlU&t=7193s" target="_blank"
                                    rel="noopener noreferrer" style="color: #bc4a3c;">dipaparkan</a> Auriga Nusantara ke
                                Komisi 4 DPR RI, keberadaan aparatur
                                penjaga
                                hutan selama ini cenderung terkonsentrasi di Pulau Jawa. Demikian juga penganggaran, porsi
                                anggaran
                                negara
                                per hektare kawasan hutan jauh lebih tinggi di Jawa. Karena itu, selain penambahan aparatur
                                –atau
                ...
                <div class="method-step border-b">
                    ...
                    <div class="">
                        ...
                        <p class="body-text">
                            Hampir separuh deforestasi 2025 terjadi di dalam konsesi, sementara terdapat lebih dari 9 juta
                            hektare
                            tutupan hutan alam di dalam konsesi konversi (tambang, sawit, kebun kayu). Korporasi-korporasi
                            yang
                            mengelola areal bertutupan hutan alam ini semestinya menyatakan komitmen lingkungan, sosial, dan
                            tata
                ...
                <div class="method-step border-b">
                    ...
                    <div class="">
                        ...
                        <p class="body-text">Perlindungan hutan semestinya dipandang sebagai investasi, selain karena
                            ...
                            pihak-pihak yang melindungi hutan, baik komunitas lokal, pemerintah daerah (provinsi, kabupaten,
                            dan
                            desa), maupun korporasi. Selain insentif, manfaat ekonomi, seperti jasa karbon, atas keberadaan
                            hutan
                            semestinya diperoleh juga oleh pihak-pihak yang melindungi hutan. Insentif dan manfaat ekonomi
                            ini
                            selain
            ...
            <div class="author-block film-credit-block">
                ...
                <div class="ab-group">
                    ...
                    <div class="ab-names">Achmad Rafly Gymnastiar, Aditya Prima Yudha, Adzra Aqila Muthia, Andhika
                        Younastya,
                        Anggun Detrina Napitupulu, Annisa Meira Nurfauziah, Bagus Sugiarto, Cecilinia Tika Laura, Chairul
                        Soleh,
                ...
                <div class="ab-group">
                    <div class="ab-names">© Auriga Nusantara. 2026. <br><em>Status Deforestasi di Indonesia 2025, diakses
                            pada
