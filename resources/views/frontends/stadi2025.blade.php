    ...
    <nav id="sitenav"
        ...
        <div class="nav-actions">
            ...
            <div class="global-lang" aria-label="language switcher">
                <a href="{{ url('/id/status-deforestasi-di-indonesia-2025') }}" id="lang-id" class="g-lang-btn active">ID</a>
                            ...
                            <div id="peta-charts-wrap" class="absolute inset-0 pointer-events-none">
                                ...
                                <div class="peta-island-chart hidden absolute pointer-events-auto origin-top-left scale-75 sm:scale-100"
                                    ...
                                    <div
                                        ...
                                        <div
                                            class="font-poppins text-[1.1rem] font-bold text-[#1a1a1a] mb-0.5 leading-[1.05]">
                                            Sumatera</div>
        ...
        <div class="block sm:max-w-6xl mx-auto mb-4 text-left">
          ...
          <i>Deforestasi 2025 per wilayah administrasi, area konservasi, dan konsesi.</i>
           ...
           <div class="mx-[50px] relative pl-5 py-2">
            ...
            <p class="text-black text-[20px] md:text-[25px] leading-relaxed font-extralight italic ">
            Dari 433.751 hektare deforestasi 2025, 166.590 hektare merupakan spot deforestasi yang terjadi pada skala luas di atas 5 hektare. Sebanyak 62% deforestasi terjadi pada skala luas di bawah 5 hektare, dengan 149.159 hektare terjadi pada skala luas 1–5 hektare.<span class="font-extralight -pl-4" style="font-size: 3.5rem; line-height: 0; vertical-align: -0.3em;">&rdquo;</span>
            </p>
        </div>
                    ...
                    <div class="method-step border-b">
                        ...
                        <div class="">
                            ...
                            <p class="body-text">Perlindungan hutan semestinya dipandang sebagai investasi, selain karena
                                ...
                                perlindungan
                                hutan
                                dalam jangka panjang oleh pihak-pihak tersebut.<span
                                    class="text-[#bc4a3c] text-2xl">●</span>
                            </p>
                        </div>
                    </div>
                </div>
