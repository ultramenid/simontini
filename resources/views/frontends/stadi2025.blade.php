...
>>>>>>> Stashed changes
  ...
  <div class="viz-block viz-block--full alur" style="margin-top: -60px !important;">
    <div class="block w-full sm:max-w-6xl mx-auto">
      <h2 class=" text-[#1a1a1a] text-lg md:text-xl font-bold tracking-tight mb-1">Tahapan dan pemrosesan data
        deforestasi
        2025</h2>
      {{-- <p class="chart-sub text-sm" style="color:#8b7355;">Annual deforestation rate ·
        hectares</p> --}}
          ...
          <div
            ...
            <table
              ...
              <thead>
                ...
                <tr>
                  <th class="w-[16%] bg-[#a33520] px-2 py-2 text-left font-semibold text-white/90 sm:px-4">
                    Strata (ha)
                  </th>
                  <th class="w-[17%] bg-[#a33520] px-2 py-2 text-right font-semibold text-white/90 sm:px-4">
                    Luas (ha)</th>
                  <th class="w-[14%] bg-[#a33520] px-2 py-2 text-right font-semibold text-white/90 sm:px-4">
                    Poligon</th>
                  <th class="w-[18%]  bg-[#a33520] px-2 py-2 text-right font-semibold text-white/90 sm:px-4">
                    Sampel
                    poligon</th>
                  <th class="w-[10%] bg-[#a33520] px-2 py-2 text-right font-semibold text-white/90 sm:px-4">
                    TRUE</th>
                  <th class="w-[25%] bg-[#a33520] px-2 py-2 text-right font-semibold text-white/90 sm:px-4">
                    Akurasi</th>
                </tr>
              </thead>
              <tbody>
    ...
    <section class="page-section px-[5vw] py-8">
      ...
      <p class="body-text">
        ...
        dari tahun sebelumnya seluas <a href="https://simontini.id/id/status-deforestasi-indonesia-2024" target="_blank"
          rel="noopener noreferrer" style="color: #bc4a3c;">261.575 hektare</a>. Deforestasi
      ...
      <div>
        ...
        <div id="peta-embed" class="mx-auto">
          <div class="block sm:max-w-6xl mx-auto mb-4 text-left">
            <h2 class=" text-[#1a1a1a] text-lg md:text-xl font-bold tracking-tight mb-1">Deforestasi per pulau
              besar
              Indonesia</h2>
            {{-- <p class="chart-sub text-sm" style="color:#8b7355;">Annual deforestation rate ·
              hectares</p> --}}
                ...
                <div class="peta-island-chart hidden absolute pointer-events-auto origin-top-left scale-75 sm:scale-100"
                  ...
                  <div
                    ...
                    <div class="font-poppins text-[1.1rem] font-bold text-[#1a1a1a] mb-0.5 leading-[1.05]">
                      Sumatera</div>
                    <div class="font-poppins text-[.52rem] font-bold text-[#1a1a1a] mb-2.5">ribu
                      hektare</div>
      ...
      <div class="viz-block viz-block--full mt-10 mb-6" id="chart-monthly-wrap">
        <div class="max-w-4xl mx-auto">
          <div class="block w-full sm:max-w-6xl mx-auto mb-4">
            <h2 class=" text-[#1a1a1a] text-lg md:text-xl font-bold tracking-tight mb-1">Deforestasi per bulan
              di
              Indonesia pada 2025</h2>
            {{-- <p class="chart-sub text-sm" style="color:#8b7355;">Annual deforestation rate ·
              hectares</p> --}}
          </div>
          <div class="">
      ...
      <div class="mx-[50px] relative pl-10 py-2">
        ...
        <span class="absolute top-0 left-0 text-black font-black leading-none"
          style="font-size: 3.5rem; line-height: 1;">"</span>
<<<<<<< Updated upstream

        <p class="text-black text-[20px] md:text-[20px] font-semibold leading-snug">
          Pada 2025, area deforestasi di atas 5 ha seluas 166.590 hektare. Sebanyak 62% deforestasi terjadi pada skala
          luas di bawah 5 hektare, dengan 149.159 hektare terjadi pada skala luas 1–5 hektare."
        </p>
      </div>
    ...
    <section class="page-section px-[5vw] pt-10 pb-20">
      <div class="mx-auto max-w-[820px]">
        ...
        <div class="method-steps">
            ...
            <div class="">
              ...
              <p class="body-text ">
                ...
                <a href="https://www.youtube.com/watch?v=Mx4638DmEjI" target="_blank" rel="noopener noreferrer"
                  style="color: #bc4a3c;">(55%) area ini bertutupan hutan
                  alam</a>.
                ...
                <a href="https://korankaltara.com/762-ribu-hektare-hutan-diusulkan-beralih-fungsi" target="_blank"
                  rel="noopener noreferrer" style="color: #bc4a3c;">762.000
                  hektare</a>.
          ...
          <div class="method-steps">
            <div class="border-b pt-0 pb-12">
              <div class="method-step " style="padding-top: 0;">
                <div class="ms-num">3.</div>
                <div class="">
                  <h4 class="chapter-title">Percepatan perluasan area preservasi, terutama di luar
                    kawasan hutan</h4>
                  <br>
                  <p class="body-text relative z-10">
          ...
          <div class="max-w-5xl mx-auto px-10 z-20 relative">
            ...
            <div x-data="{
              ...
              <div class="sm:flex hidden flex-col sm:flex-row sm:justify-between gap-4 mt-4">
                ...
                <div class="text-right text-[12px] leading-tight flex flex-col justify-between min-h-[60px] max-w-xl">
            ...
            <div x-data="{
              ...
              <div class="sm:flex hidden flex-col sm:flex-row sm:justify-between gap-4 mt-4">
                <div class="grid grid-cols-3 gap-2 sm:flex sm:gap-2" :style="$el.offsetParent && window.innerWidth < 640 ? 'width: ' + $refs.mainImg
                                                              .offsetWidth + 'px' : ''">
                  <template x-for="(img, index) in images" :key="index">
                    <div @click="active = index" class="cursor-pointer aspect-square sm:w-20 sm:h-40" :class="active === index ? 'opacity-100 ring-2 ring-black' :
                                                                      'opacity-50 hover:opacity-80'">
                      <img :src="img.src" alt="thumbnail"
                        class="w-full h-full object-cover object-top transition duration-200" />
                    </div>
                    ...
                    <div class="flex  " :style="'transform: translateX(-' + (currentSlide * 100) + '%)'">
                      ...
                      <template x-for="(item, index) in images" :key="index">
                        <div class="w-full flex-shrink-0 flex flex-col">
                          ...
                          <div class="max-w-6xl mx-auto px-12 sm:px-0 text-justify relative z-10"
                            style="line-height: 1; padding-right: 12rem; padding-left: 8.5rem;">
                            <small style="font-size: 12px;" x-html="item.desc"></small>
                          </div>

                          <!-- GAMBAR -->
                          <div class="relative" style="margin-top: -4.5rem;">
                            <img :src="item.src" @click="openLightbox(index)"
...
>>>>>>> Stashed changes
                    ...
                    <a href="https://www.youtube.com/watch?v=fXpCyo4TrlU&t=7193s" target="_blank"
                      rel="noopener noreferrer" style="color: #bc4a3c;">dipaparkan</a> Auriga
