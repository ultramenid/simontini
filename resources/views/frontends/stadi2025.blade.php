  ...
  <section id="hero">
    ...
    <section class="page-section px-[5vw]  section-after-chart">
        <div class="section-body">
            ...
            <p class="body-text">
                <strong>Tahapan dan pemrosesan data.</strong> Peta deforestasi 2025 diperoleh dengan pemodelan deep learning
                pada
            ...
            <div class="method-steps">
                <div class="method-step">
                    ...
                    <div class="body-text">
                        <p>
                            <strong>Pemodelan deforestasi.</strong> Pengetahuan yang terkumpul selama ini, seperti dari
                            pemantauan
                            lapangan dan data-data
                            deforestasi
                            <a href="https://simontini.id/presentation/Deforestasi_Indonesia-2023-paparan.pdf"
                                target="_blank" rel="noopener noreferrer" style="color: #bc4a3c;">2023</a>
                ...
                <div class="method-step">
                    ...
                    <div class="body-text">
                        ...
                        <p><strong>Penentuan area cakupan</strong> (<em>scoping area</em>). Isyarat deforestasi
                            (<em>deforestation
                                alert</em>, atau biasa disebut GLAD alert) bulanan yang diproduksi Universitas Maryland
                            dikumpulkan. Demi
                            efektivitas, yang dikumpul hanya isyarat dengan tingkat kepercayaan tinggi (<em>high
                                confidence</em>).
                ...
                <div class="method-step">
                    ...
                    <div class="body-text">
                        ...
                        <p><strong>Model deforestasi</strong> yang telah dibangun kemudian<strong> dijalankan pada citra
                                satelit
                                Sentinel 2
                ...
                <div class="method-step">
                    ...
                    <div class="body-text">
                        ...
                        <p> <strong> Area-area yang terdeteksi deforestasi </strong> (deforestasi indikatif)
                            ...
                            (<em>overlay</em>) <strong>dengan peta tutupan hutan</strong>. Terdapat 4 referensi tutupan
                            hutan yang
                            dipakai, yakni: (1)
                ...
                <div class="method-step">
                    ...
                    <div class="body-text">
                        <!-- <h4>Pemantauan lapangan</h4> -->
                        <p><strong>Penapisan </strong> (<em>filtering</em>). Dengan berfokus pada deforestasi yang
                            diakibatkan oleh
                            aktivitas manusia (<em>anthropogenic deforestation</em>), penapisan dilakukan dengan
    ...
    <div class="viz-block viz-block--full alur" style="margin-top: -60px !important;">
        ...
        <section class="page-section px-[5vw] pt-8 pb-6">
            <div class="body-text">
                <p>
                    <strong>Uji akurasi</strong>. Uji akurasi dilakukan untuk mengetahui tingkat akurasi data deforestasi
                    2025 ini,
                    dengan menginspeksi secara visual poligon deforestasi pada citra Planet Scope resolusi spasial 3,7
                    meter.
                    Poligon yang diinspeksi dipilih secara acak (<em>random</em>) dengan metode <em>stratified random
                        sampling</em>.
                ...
                <div class="max-w-3xl mx-auto mt-4">
                    ...
                    <div
                        ...
                        <div class="border-b border-[#ddd5c8] px-4 py-4 sm:px-6">
                            <div class="text-[12px] font-semibold tracking-[-0.01em] text-[#1a1a1a] sm:text-[13px]">Hasil
                                uji akurasi
