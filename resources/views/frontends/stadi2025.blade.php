        ...
        <div class="viz-frame viz-frame--padded">
          <div class="mx-auto w-full" style="max-width:980px;">
            ...
            <div style="overflow:hidden;">
              ...
              <div id="gallery" data-index="0">

                <div class="w-full aspect-[16/9] overflow-hidden relative group">

                  <img id="mainImage" src="{{ asset('assets/images/gallery2025/Kawasan Hutan Produksi.jpg') }}"
                    class="w-full h-full object-cover cursor-pointer transition duration-300 group-hover:brightness-75"
                    onclick="
      let imgs = $('#galleryThumbs img');
      let i = Number($('#gallery').data('index')) || 0;

      let el = imgs.eq(i);

      $('#popupGallery').data('index', i);
      $('#popupGalleryImage').attr('src', el.attr('src'));

      $('#popupGalleryTitle').text(el.data('title'));
      $('#popupGallerySub').text(el.data('sub'));

      if(i === 0){ $('#prevBtn').hide(); } else { $('#prevBtn').show(); }
      if(i === imgs.length - 1){ $('#nextBtn').hide(); } else { $('#nextBtn').show(); }

      $('#popupGallery').fadeIn(200);
    ">

                  <button id="prevMain"
                    class="absolute left-3 top-1/2 -translate-y-1/2 bg-black/60 text-white px-3 py-2 text-2xl cursor-pointer hidden">
                    ‹
                  </button>

                  <button id="nextMain"
                    class="absolute right-3 top-1/2 -translate-y-1/2 bg-black/60 text-white px-3 py-2 text-2xl cursor-pointer">
                    ›
                  </button>
                ...
                <div
                  ...
                  <div id="galleryThumbs" class="flex gap-3 overflow-x-auto md:overflow-visible">

                    <img class="w-[70px] h-[70px] sm:w-[80px] sm:h-[80px] object-cover border cursor-pointer shrink-0"
                      src="{{ asset('assets/images/gallery2025/Kawasan Hutan Produksi.jpg') }}"
                      data-title="Kawasan Hutan Produksi" data-sub="Bireun, Aceh, Desember 2025" onclick="
                            $('#mainImage').attr('src', this.src);
                            $('#title').text($(this).data('title'));
                            $('#sub').text($(this).data('sub'));
                    ...
                    <img class="w-[70px] h-[70px] sm:w-[80px] sm:h-[80px] object-cover border cursor-pointer shrink-0"
                      src="{{ asset('assets/images/gallery2025/Konsesi PBPH, PT Toba Pulp Lestari,.jpg') }}"
                      data-title="Konsesi PBPH, PT Toba Pulp Lestari" data-sub="Aek Raja, Sumatera Utara, Desember 2025"
                      onclick="
                            $('#mainImage').attr('src', this.src);
                            $('#title').text($(this).data('title'));
                            $('#sub').text($(this).data('sub'));

                            $('#gallery').data('index', 1);
                            $('#prevMain').show();
                            $('#nextMain').show();
                          ">

                    <img class="w-[70px] h-[70px] sm:w-[80px] sm:h-[80px] object-cover border cursor-pointer shrink-0"
                      src="{{ asset('assets/images/gallery2025/Deforestasi, Kawasan Hutan Lindung,.jpg') }}"
                      data-title="Kawasan Hutan Lindung" data-sub="Sijunjung, Sumatera Barat, Desember 2025" onclick="
                            $('#mainImage').attr('src', this.src);
                            $('#title').text($(this).data('title'));
                            $('#sub').text($(this).data('sub'));

                            $('#gallery').data('index', 2);
                            $('#nextMain').hide();
                            $('#prevMain').show();
                          ">
                  ...
                  <div
                    class="text-right text-[13px] sm:text-[14px] leading-snug md:ml-auto max-w-full md:max-w-[280px] break-words">
        ...
        <div class="viz-frame viz-frame--padded">
          <div class="mx-auto w-full" style="max-width:980px;">
            ...
            <div>
              ...
              <!-- IMAGE -->
              <div class="w-full aspect-[16/9] overflow-hidden group">
                <img src="{{ asset('assets/images/gallery2025/Konsesi Sawit, PT Banyan Tumbuh Lestari.jpg') }}"
                  class="w-full h-full object-cover cursor-pointer transition duration-300 group-hover:brightness-75" onclick="
                                                    let img = $('#popupImage');
...
@endsection
  ...
  ">
    ...
    <button onclick="$('#popup').fadeOut(200)"
      class="absolute top-4 right-4 text-white text-2xl z-[1000000] cursor-pointer hover:opacity-70 active:scale-90 transition">
      ✕
    </button>
  ...
  ">
    ...
    <div class="w-full max-w-[1100px]">
      ...
      <div class="relative">
        ...
        <img id="popupGalleryImage" src="" class="w-full max-h-[80vh] object-contain">

        <button onclick="
        let imgs = $('#galleryThumbs img');
        let i = Number($('#popupGallery').data('index')) || 0;
        ...
        $('#popupGalleryTitle').text(el.data('title'));
        $('#popupGallerySub').text(el.data('sub'));
      " class="absolute left-3 top-1/2 -translate-y-1/2 bg-black/60 text-white px-3 py-2 text-3xl cursor-pointer">
          ‹
        </button>
        ...
        $('#popupGalleryTitle').text(el.data('title'));
        $('#popupGallerySub').text(el.data('sub'));
      " class="absolute right-3 top-1/2 -translate-y-1/2 bg-black/60 text-white px-3 py-2 text-3xl cursor-pointer">
          ›
        </button>

      </div>

      <div class="bg-white text-black px-4 py-3 text-sm ">
        <div id="popupGalleryTitle" class="text-xs"></div>
        <div id="popupGallerySub" class="text-xs opacity-70 mt-1"></div>
      </div>
